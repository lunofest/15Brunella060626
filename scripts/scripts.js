...
const fechaObjetivo = new Date("june 6, 2026 20:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const numeroWhatsapp = '542634403639';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const recipientNumber1 = '542634403639'; // Número para el primer botón
